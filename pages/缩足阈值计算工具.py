...
5. **终止条件：**  
   ...
   **特殊情况：**  
   ...
   1.若从 0.6g 开始，动物连续5次出现阳性反应（即到最小克重 0.04g 动物仍出现缩足或舔足反应）或连续5次出现阴性反应（即到最大克重 4.0g 动物仍不出现缩足或舔足反应），即可直接使用 0.04g 或 4.0g 作为动物 50%缩足反应阈值；  
   2.若已出现反应翻转，但测试到最小或最大纤维丝时不足 4 次（如 1111011，即下次测量纤维丝克重将超出设定范围），则继续使用最小或最大纤维丝按照“Up & Down”测量记录，以排除假阳性或假阴性可能；
