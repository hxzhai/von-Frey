...
3. **确定起始刺激丝：**  
   测试应从所选刺激丝中 **中位克重的一根** 开始刺激（如选择了9根丝，对应克重分别为 0.04g、0.07g、0.16g、0.4g、0.6g、1.0g、1.4g、2.0g、4.0g，则从中位 0.6g 开始测试）。
...
⚠️ 必须从第一次刺激开始记录反应（即第一次中位克重刺激），而不是从“反应发生翻转”之后才开始记录！

5. **终止条件：**  
   首次观察到反应结果阴阳翻转后，**继续测试 4 次**终止（即第一次0变1、或1变0后，继续测试4次，继续测试的次数**可以小于4次，不能多于4次**）。  
   **特殊情况：**  
   eg：取一系列克重连续的 von Frey 纤维丝（如 0.04、0.07、0.16、0.4、0.6、1、1.4、2.0、4.0g 共 9 根）  
